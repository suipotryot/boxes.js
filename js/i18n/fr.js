...
export const fr = {
  ...
  'hole.centerX': 'Centrer sur X',
  'hole.centerY': 'Centrer sur Y',
  ...
  'settingsPanel.lidHelp': 'Ajoute un couvercle plat qui s’assemble aux parois extérieures.',
  'settingsPanel.lidMode': 'Position',
  'settingsPanel.lidModeHelp': 'Encastré : le couvercle repose à une hauteur d’insertion réglable, maintenu par des trous de mortaise mi-hauteur. Posé au-dessus : le couvercle repose sur le dessus des parois, qui ajoutent des doigts pour l’accueillir — comme le socle, mais en miroir.',
  'settingsPanel.lidModeRecessed': 'Encastré',
  'settingsPanel.lidModeOnTop': 'Posé au-dessus',
